...
Lots of fire hydrantModels cover the entire area of New York City. 
In case of a fire, a fire brigade arrives with N trucks and connects firehoses to the N nearest hydrantModels in the fire area. 
...
- list of N nearest hydrantModels used by the fire brigade, with its unitId and distance to the fire
